...
function execute(input)
  ...
  -- If the following variable is true, the strategy will consider existing (input) flags
  -- as bad data. It will exclude the on-input flagged data from detection, and make sure that any existing
  -- input flags will stay flagged in the output. If set to false, input flags are ignored.
